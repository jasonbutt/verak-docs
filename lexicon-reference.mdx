...
description: The complete schema reference for all AT Protocol lexicons used by Verak, covering both the open SIFA standard and Verak's own sovereign namespace.
---
...
### `is.verak.endorsement` _(specified, not yet live)_
