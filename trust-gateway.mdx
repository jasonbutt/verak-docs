...
|---|---|---|---|
| `kevara-verified` | Identity verified by Kevara | Manual review via Keytrace flow | Kevara + any subscribing AT Protocol client |
...
If you are an institution or enterprise verifier interested in early integration, reach out at [trust@kevara.co](mailto:trust@kevara.co).
